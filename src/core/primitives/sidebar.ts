...
function body(props: Props, layout: Layout, scale: Scale, side: 'left' | 'right', ctx: CanvasRenderingContext2D) {
...
function border(props: Props, layout: Layout, side: 'left' | 'right', ctx: CanvasRenderingContext2D): {x: number, y: number, w: number, h: number} {
...
function panel(props: Props, layout: Layout, scale: Scale, side: 'left' | 'right', ctx: CanvasRenderingContext2D) {
    ...
    roundRect(ctx, x , y, panWidth, panHeight, 3, S ? 1 : 0)
...
function roundRect(ctx: CanvasRenderingContext2D, x: number, y: number, w: number, h: number, r: number, s: number) {
    if (w < 2 * r) r = w / 2
    if (h < 2 * r) r = h / 2
    ctx.beginPath()
    ctx.moveTo(x+r, y)
...
function upperBorder(props: Props, layout: Layout, ctx: CanvasRenderingContext2D) {
...
function error(props: Props, layout: Layout, side: 'left' | 'right', ctx: CanvasRenderingContext2D) {
