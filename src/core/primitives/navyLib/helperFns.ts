...
export function fastSma(
    ...
    let out: number[][] = [] // Output time-series
...
export function candleColor(
    props: { colorBodyUp: string; colorBodyDw: string },
    candle: number[] = []
): string {
...
export function rescaleFont(fontString: string, newSize: number): string {
