...
export default class Pin {
    ...
    constructor(core: any, line: any, name: string, params: { state?: string; hidden?: boolean } = {}) {
    ...
    draw_circle(ctx: CanvasRenderingContext2D) {

        let r: number, lw: number
    ...
    update() {
        ...
        this.data[this.name] = [this.t ?? 0, this.y$ ?? 0]
    ...
    mousedown(event: MouseEvent, force: boolean = false) {
