...
export default function layoutCnvFast(
    core: Core,
    $c: boolean = true,
    $v: boolean = true,
    vIndex: number = 5,
    ...
    dwBodies: CandleData[]
    dwWicks: CandleData[]
    upVolbars: VolumeData[]
    dwVolbars: VolumeData[]
    maxVolume: number
    volScale: number
} {
    ...
    let upBodies: CandleData[] = []
    let dwBodies: CandleData[] = []
    let upWicks: CandleData[] = []
    let dwWicks: CandleData[] = []
    let upVolbars: VolumeData[] = []
    let dwVolbars: VolumeData[] = []
