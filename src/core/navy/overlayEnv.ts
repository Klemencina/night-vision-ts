...
import Scan from '../dataScanner'
import Utils from '../../stuff/utils'
import Mouse from '../input/mouse'
import Keys from '../input/keys'

// Build-in primitives
import Candle from '../primitives/navyLib/candle'
import candleBody from '../primitives/navyLib/candleBody'
import candleWick from '../primitives/navyLib/candleWick'
import volumeBar from '../primitives/navyLib/volumeBar'
import Volbar from '../primitives/navyLib/volbar'
import layoutCnv from '../primitives/navyLib/layoutCnvFast'
import avgVolume from '../primitives/navyLib/avgVolume'
import roundRect from '../primitives/navyLib/roundRect'
import drawArrow from '../primitives/navyLib/arrow'
import TrendLine from '../primitives/navyLib/trendLine'
import Segment from '../primitives/navyLib/seg'
import Pin from '../primitives/navyLib/pin'
import {
    fastSma, candleColor, rescaleFont
} from '../primitives/navyLib/helperFns'
...
export default class OverlayEnv {
    ...
    constructor(id: number, ovSrc: OverlaySource, layout: Layout | null, props: Props) {
    ...
    update(overlay: OverlaySource, layout: Layout | null, props: Props) {
    ...
    // variables
    buildLayout(layout: Layout, range: any, overlay: OverlaySource): any {
        let obj: any = {}
    ...
    getScaleId(layout: Layout): string | undefined {
