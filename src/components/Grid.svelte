<script>
    ...
    import OverlayEnv from '../core/navy/overlayEnv'
    import Layer from '../core/layer'
    import Pointer from '../core/input/pointer'
    import Keyboard from '../core/input/keyboard'
    import Crosshair from '../core/primitives/crosshair'
    import Grid from '../core/primitives/grid'
    import Trackers from '../core/primitives/trackers'
...
<div class="nvjs-grid" {style}>
    {#each renderers as rr}
        {#if rr.ctxType === 'Canvas'}
            <Canvas {id} bind:this={rr.ref} {layout} {props} {rr} />
        {/if}
    {/each}
</div>
