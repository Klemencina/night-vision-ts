...
### $lib.Candle <span style="font-weight: 300;"> - Draws candle [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/primitives/navyLib/candle.ts)</span>
### $lib.Volbar <span style="font-weight: 300;"> - Draws volume bar [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/primitives/navyLib/volbar.ts)</span>
### $lib.layoutCnv <span style="font-weight: 300;"> - Calculates candle & volume layout [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/primitives/navyLib/layoutCnvFast.ts)</span>
### $lib.formatCash <span style="font-weight: 300;"> - Formats number in the following format, e.g.: `1.2M` [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/stuff/utils.ts)</span>
### $lib.candleBody <span style="font-weight: 300;"> - Draws candle body fast [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/primitives/navyLib/candleBody.ts)</span>
### $lib.candleWick <span style="font-weight: 300;"> - Draws candle wick fast [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/primitives/navyLib/candleWick.ts)</span>
### $lib.volumeBar <span style="font-weight: 300;"> - Draws volume bar fast [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/primitives/navyLib/volumeBar.ts)</span>
### $lib.fastSma <span style="font-weight: 300;"> - Calculates SMA fast [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/primitives/navyLib/helperFns.ts)</span>
### $lib.avgVolume <span style="font-weight: 300;"> - Draws average volume fast [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/primitives/navyLib/avgVolume.ts)</span>
### $lib.candleColor <span style="font-weight: 300;"> - Detects candle color [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/primitives/navyLib/helperFns.ts)</span>
...
Script Environment of the script: [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/se/script_env.ts).
...
Script Engine reference. [src](https://github.com/Klemencina/night-vision-ts/blob/main/src/core/se/script_engine.ts)
